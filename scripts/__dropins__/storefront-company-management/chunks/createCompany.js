...
`,u="US",o={defaultCountry:u,storeCode:""},I=async()=>await s(g,{method:"GET"}).then(e=>{var n;return(n=e.errors)!=null&&n.length?c(e.errors):p(e)}).catch(a),p=e=>{var r;if(!((r=e==null?void 0:e.data)!=null&&r.storeConfig))return o;const{default_country:n,store_code:t}=e.data.storeConfig;return{defaultCountry:n||o.defaultCountry,storeCode:t||o.storeCode}},m=`
