...
`,I=async()=>{const i="_company_countries",e=sessionStorage.getItem(i);return e?JSON.parse(e):await c(f,{method:"GET"}).then(t=>{var r;if((r=t.errors)!=null&&r.length)return p(t.errors);const n=h(t);return sessionStorage.setItem(i,JSON.stringify(n)),n}).catch(y)};export{A as a,I as g,E as t,w as v};
